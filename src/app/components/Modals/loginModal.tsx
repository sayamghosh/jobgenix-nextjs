    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-[1px] flex items-center justify-center z-50">
      <div className="border  items-center border-[#333] rounded-[30px] text-white w-[400px] p-8 shadow-lg backdrop-blur-sm">
        ...
        <form className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-2 rounded-md bg-[#0073E6] hover:bg-blue-700 transition font-semibold"
          >
            Sign Up
          </button>
        </form>
        <a
          href="#"
          className="hover:underline w-full flex justify-end text-sm text-gray-300 mt-2"
        >
          Forgot Password ?
        </a>
